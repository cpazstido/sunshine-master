...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "sunshine:restPwd";
	private static final String ACTIVE_USER = "sunshine:activeUser";
	private static final String SEND_SMS_COUNT = "sunshine:sms:count";
	private static final String SEND_EMAIL_CODE = "sunshine:email:code";
	private static final String ACCESS_TOKEN = "sunshine:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "sunshine:file:upload_file_size";
